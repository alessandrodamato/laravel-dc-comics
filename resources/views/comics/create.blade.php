          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="mb-3">
                ...
                <input name="sale_date" type="text" class="form-control" id="sale_date" placeholder="Data di uscita">
              </div>
            </div>
            ...
            <div class="col-12">
              <div class="mb-3">
                ...
                <textarea name="description" class="form-control p-0" id="description" rows="8">
                </textarea>
              </div>
            </div>
