...
Per la navigazione: 
- la rotta home è fuori dalla CRUD (se si s vuole si può stampare il numero di card presenti)  
...
- una volta salvati i dati reindirizzare alla show: return redirect()->route('mia_tabella.show', $nuovo_elemento)
